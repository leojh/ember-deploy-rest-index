...
module.exports = CoreObject.extend({
  ...
  _upload: function(key, indexHtml) {
    return new Promise(function(resolve, reject) {
      ...
      this._writeLineInGreen("POST '" + path + "' to add revisions for '" + this.environment + "'");
  ...
  _list: function() {
    return new Promise(function(resolve, reject) {
      var path = this._buildPath(this.environment);

      this._writeLineInGreen("GET '" + path + "' to get revisions for '" + this.environment + "'");
      this._writeEmptyLine();
  ...
  _buildPath: function(environment) {
    var path = this.serviceHost + '/' + this.serviceNamespace + '/' + this.serviceIndexVersionResource;
