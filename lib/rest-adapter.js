...
module.exports = CoreObject.extend({
  init: function(options) {
    ...
    this.basicAuthUser = this.config.basicAuthUser;
    this.basicAuthPassword = this.config.basicAuthPassword;
    ...
    if (this.basicAuthUser) { clientOpts.user = this.basicAuthUser; }
    if (this.basicAuthPassword) { clientOpts.password = this.basicAuthPassword; }
